...
const args = mri(argv, {boolean: ['include-intermediates', 'include-nightly', 'include-beta']});
...
(async () => {
	...
	switch (args.mode) {
		case 'range':
			...
			const _ranges = await abis.getRange(abi, runtime, {includeIntermediates, includeNightly, includeBeta});
